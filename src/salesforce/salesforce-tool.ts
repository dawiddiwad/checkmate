...
export class SalesforceTool implements OpenAITool {
				...
				function: {
					...
					parameters: {
						...
						properties: {
							goal: {
								type: 'string',
								description: 'The goal or purpose of logging into the Salesforce org',
							},
						},
	...
	private async getSalesforceLoginUrl(): Promise<string> {
		return new SalesforceCliAuthenticator(new SalesforceCliHandler()).ready.then((authenticator) =>
