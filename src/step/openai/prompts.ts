...
export const STEP_SYSTEM_PROMPT = () => `You are quality assurance assistant executing tests steps. 
...
If you cannot find elements try calling '${BrowserTool.TOOL_SNAPSHOT}' tool to get the latest full snapshot of the page.
