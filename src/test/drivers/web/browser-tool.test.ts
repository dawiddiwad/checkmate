...
import { BrowserTool, BrowserToolRuntime, createBrowserTools } from '../../../drivers/web/tools/tool'
...
vi.mock('../../../drivers/web/tools/snapshot-service', () => ({
...
describe('Browser tools', () => {
	...
	beforeEach(() => {
		...
		runtime = new BrowserToolRuntime(
			...
			{ snapshotFilter: false, snapshotTopPercent: 10 },
			silentLogger
		)
